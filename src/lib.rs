...
#[derive(Debug)]
pub struct MobXStateProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MobXStateProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MobXState processing");
    
    let mut processor = MobXStateProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MobXStateProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MobXStateProcessor::new(false);
